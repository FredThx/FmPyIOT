...
TOPIC_IN = 'test/mqtt_async_in'
TOPIC_OUT = 'test/mqtt_async_out'
...
async def up(client):
    while True:
        ...
        await client.subscribe(TOPIC_IN, 1)
...
async def main(client):
    ...
    while True:
        ...
        await client.publish(TOPIC_OUT, '{} repubs: {} outages: {}'.format(n, client.REPUB_COUNT, outages), qos = 1)
        n += 1

# Define configuration
config['will'] = (TOPIC_OUT, 'Goodbye cruel world!', False, 0)
